...
export function readSession(database, req) {
  ...
  const token = cookies["__Host-risulta_session"] || cookies.risulta_session || cookies["__Host-hutch_session"] || cookies.hutch_session;
...
export function expiredCookies() {
  return [
    ...
    "hutch_session=; Path=/; HttpOnly; SameSite=Lax; Max-Age=0",
    "__Host-hutch_session=; Path=/; HttpOnly; SameSite=Lax; Secure; Max-Age=0",
  ];
}
