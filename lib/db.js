...
export class SiteStore {
  constructor(path) {
    ...
    this.funnelEventsStatement = this.db.prepare(`
      SELECT visitor, ts, name, path FROM events WHERE ts >= ? ORDER BY visitor, ts`);
